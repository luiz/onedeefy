...
<pre>
java -jar onedeefy-1.0.jar background.jpg background-1D.jpg
</pre>
...
<pre>
java -jar onedeefy-1.0.jar background-1D.jpg 1024 768 background-2D.jpg
</pre>

Oh, and you can also use it directly in your Java code. Simply add it to your classpath and use the Spiralizer methods to "spiralize" (transform into 2D) or "despiralize" (transform into 1D) your image.
